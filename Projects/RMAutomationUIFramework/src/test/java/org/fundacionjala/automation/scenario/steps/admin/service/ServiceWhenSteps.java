...
public class ServiceWhenSteps {
	...
	public void i_add_a_new_Exchange_Email_Server_with_description(String myExpectedDescription) throws Throwable {
	...
	public void i_modify_credential_with_user_name_and_password(String newUserName, String newPassword) throws Throwable {
		LoginPage login = new LoginPage();
