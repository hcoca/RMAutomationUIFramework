...
public class EditMeetingGivenSteps {
    ...
    @Given("^I have a created meeting with \"([^\"]*)\" subject in the \"([^\"]*)\" room$")
    public void IHadAMeetingCreated(String subject, String room)
	    throws Throwable {
	...
	Meeting meeting = new Meeting(
		...
		startDate, endDate, room, roomEmail, roomEmail, attendees);
    ...
    @Given("^I have a created meeting from \"([^\"]*)\" to \"([^\"]*)\", with \"([^\"]*)\" subject in the \"([^\"]*)\" room$")
	...
	loginPage.setUserName(PropertiesReader.getUserName())
