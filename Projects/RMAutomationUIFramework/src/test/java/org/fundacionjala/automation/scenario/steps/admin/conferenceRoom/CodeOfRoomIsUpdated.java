...
public class CodeOfRoomIsUpdated {
	...
	public void i_edit_room_with_a_new_code(String roomName, String newCode) throws Throwable {
	...
	public void i_validate_if_the_Code_has_been_updated_in_the_Room_Info_Page() throws Throwable {
		Assert.assertTrue(
				Home
			   	.leftMenu
			   	.clickOnConferenceRoomsButton()
