...
public class CapacityOfRoomsIsUpdated {
    ...
    public void i_edit_room_with_a_new_capacity(String roomName,
	    String newCapacity) throws Throwable {
    ...
    public void i_validate_if_the_Capacity_has_been_updated_in_the_Room_Info_page()
	    throws Throwable {
