...
Given I have a location added with name: "Cochabamba_10", display name "Cbba-Location_10" and description "This is Cochabamba Location"
	And I am logged as "Administrator" with password "Control*123"
When I associate the location "Cbba-Location_10" with a room "Room002"
Then The room "Room002" is displayed on Location Association page as associated with "Cbba-Location_10" location
@location_by_displayname
