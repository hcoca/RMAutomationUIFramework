...
Given I have a meeting with this subject "removeMeeting" on "Room036" room
And I am on Home Page of "Room036" room
When I remove "removeMeeting" meeting
Then validate that "removeMeeting" has been removed and it is not on timeline