...
public class RoomsResourceAssociationsPage {
	...
	int posOfResourceAssociated = getResourcePos(resource,
	...
	int posResourceAssociated = getResourcePos(resource,
		getAssociatedResources());
	return quantityFields.get(posResourceAssociated).getAttribute("value")
		.equals(quantity);
    }
