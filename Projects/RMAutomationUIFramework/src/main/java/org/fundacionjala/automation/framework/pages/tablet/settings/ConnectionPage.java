...
public class ConnectionPage extends SettingsPage {
	...
	@FindBy (xpath = ConnectionMap.SERVICE_URL_TEXT_FIELD) WebElement serviceURLTextField;
	@FindBy (xpath = ConnectionMap.SAVE_BUTTON) WebElement saveButton;
	...
	public ConnectionPage setUpServiceURL(String serviceURL) {
		(new WebDriverWait(BrowserManager.getDriver(), 30)).until(ExpectedConditions.visibilityOf(serviceURLTextField));
